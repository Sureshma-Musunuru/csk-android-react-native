     ...
     if(enteredPassword.length < 4)
       ...
       else
       {
        setIsAuthenticating(true);
         axios.post("https://api.maristproject.online/api/register", {
             email: enteredEmail,
  ...
  return (
    ...
    <View style={Styles.container_login}>
      ...
      <View style={Styles.inputContainer}>
            ...
            <TextInput style={Styles.inputField} Value={enteredName} onChangeText={(val) => {setEnteredName(val)}}/>
        </View>
        <View style={Styles.inputContainer}>
        ...
        <Pressable onPress={submitHandler} style={Styles.pressable}>
          <Text style={Styles.primaryButton}>Regsiter</Text>
        </Pressable>
